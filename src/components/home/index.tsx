      ...
      <div className="relative h-[60vh] min-h-[400px] text-white flex items-center">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 z-10 text-center">
          ...
          <div className="mt-10 flex flex-wrap justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            <button className="bg-accent text-primary-foreground hover:bg-accent/90 transition-all duration-300 transform hover:scale-105">
              View Projects
              <ArrowRight className="ml-2 h-5 w-5" />
            </button>
            <button className="border-accent text-accent hover:bg-accent/10 transition-all duration-300 transform hover:scale-105">
              Contact Us
            </button>
          </div>
        </div>
